...
public class GUITiroAlBlanco4 {
    ...
    public static void main(String args[]) {
        GUITiroAlBlanco4 gui = new GUITiroAlBlanco4();
        gui.go();
    }
    ...
    public void generaGUI() {
        ...
        jframe = new JFrame("GUI Tiro Al Blanco 4");
        ...
        //
        cnvCampoTiro = new CanvasCampoTiro4();
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if ((0.0 <= ang) && (ang < 90) && (vel > 0)) {
                        ...
                        lD.add(new NuevoDisparo4(vel, ang));
                    } else {
        ...
        MiHebraCalculadoraVariosDisparoEje4 hebra = new MiHebraCalculadoraVariosDisparoEje4(cnvCampoTiro, txfInformacion, objetivo, lD);
        hebra.start();
    }
    ...
    // --------------------------------------------------------------------------
    public void creaYMueveProyectil(NuevoDisparo4 d) {
        Proyectil4 p;
        boolean impactado;

        p = new Proyectil4(d.velocidadInicial, d.anguloInicial, cnvCampoTiro);
        impactado = false;
        while (!impactado) {
...
// ============================================================================
class CanvasCampoTiro4 extends Canvas {
    // ============================================================================
...
class NuevoDisparo4 {
    ...
    // --------------------------------------------------------------------------
    public NuevoDisparo4(double velocidadInicial, double anguloInicial) {
...
class Proyectil4 {
    ...
    // --------------------------------------------------------------------------
    Proyectil4(double velocidadInicial, double anguloInicial,
               CanvasCampoTiro4 cnvCampoTiro) {
        this.posX = 0.0;
        this.posY = 0.0;
